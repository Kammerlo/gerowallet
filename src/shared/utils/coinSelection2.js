import {
    ...
    TransactionOutputs,
    Value,
    BigNum, min_ada_required,
} from '@emurgo/cardano-serialization-lib-browser/cardano_serialization_lib';
import {AssetName, Assets, MultiAsset, ScriptHash} from "@emurgo/cardano-serialization-lib-browser";
...
/**
 * CoinSelection2 Module.
 * @module src/lib/CoinSelection2
 */
const CoinSelection2 = {
    /**
