...
export default {
  name: 'DappConnect',
  components: { ToggleSwitch, CopyButton, TransactionRisk, TransactionCard, DappAddress, PopupHeader },
  data() {
    return {
      isBT: false,
      networks,
  ...
  computed: {
    ...
    ...mapState(walletConfigStore, ['config', 'utxos', 'addresses', 'getTxAutoSubmit', 'getUseSidePanel']),
    txFee() {
