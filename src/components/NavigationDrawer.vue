...
export default {
  ...
  data: () => ({
    ...
    items: [
      ...
      {title: 'Swap', icon: require('@/assets/svg/coins-swap-02.svg'), link: '/swap'},
      {title: 'Staking', icon: require('@/assets/svg/coins-stacked-02.svg'), link: '/staking'},
      {title: 'Send', icon: require('@/assets/svg/send-01.svg'), link: '/send'},
      {title: 'Receive', icon: require('@/assets/svg/qr-code-01.svg'), link: '/receive'},
      // { header: 'Tools' },
