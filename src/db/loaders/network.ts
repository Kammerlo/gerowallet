...
/**
 * Loader for staking pools data
 */
export class PoolsLoader extends BaseLoader {
...
/**
 * Loader for DReps (Delegated Representatives) data
 */
export class DRepsLoader extends BaseLoader {
  constructor(private getBlockchainDb: () => Promise<Dexie>) {
    super('dreps');
  }
...
export class EpochParamsLoader extends BaseLoader {
  constructor(
    private getBlockchainDb: () => Promise<Dexie>,
    private chain: any,
    private network: any
  ) {
    super('epoch_params');
