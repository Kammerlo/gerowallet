  ...
  >
    <div
      style="
        ...
        gap: 8px;
        display: flex;
        outline: 1px var(--g-hairline-2) solid;
        outline-offset: -1px;
        margin-top: 24px;
      "
    >
      <v-carousel
        ...
        :show-arrows="false"
        style="width: 100%; position: absolute; top: 0; left: 0; right: 0; bottom: 0; border-radius: var(--g-r-sheet)"
      >
        <v-carousel-item>
          <div style="position: relative; width: 100%; height: 100%; display: flex; align-items: center; justify-content: center;">
            <v-img :src="assets.debitCardBgImage" cover style="position: absolute; width: calc(100% - 1px); height: calc(100% - 1px); top: 1px; left: 1px; z-index: 0; border-radius: var(--g-r-sheet);" />
            <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center; z-index: 2;">
              <div style="font-family: var(--g-font-ui); font-size: 24px; font-weight: 700; color: var(--g-text-1); line-height: 1.2; text-shadow: 0 2px 8px rgba(0,0,0,0.5);">
                <div>Gero</div>
                <div>Crypto</div>
                <div>Card</div>
              </div>
    ...
    >
      <div style="text-align: center">
        <span
          ...
          style="color: var(--g-accent); font-size: 24px; font-weight: 600; line-height: 34px; word-wrap: break-word"
          >Unifying</span
        >
        <span style="font-size: 24px; font-weight: 600; line-height: 34px; word-wrap: break-word"> Web2 & Web3</span>
      </div>
      <div
        style="
          text-align: center;
...
.stats-viewport {
  ...
  outline: 2px solid var(--g-hairline-2);
}
