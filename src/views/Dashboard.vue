            ...
            <v-row no-gutters>
              <v-tabs background-color="transparent" style="width: fit-content" height="28" active-class="white--text"
                ...
                <v-tab v-for="(tab,index) in tabs" :key="index"
                       style="font-size: 10px; letter-spacing: normal; min-width: 50px;" @click="tabClick(tab)">{{
                    tab
                  }}
                </v-tab>
              </v-tabs>
        ...
        <v-card outlined class="row no-gutters fill-height d-flex justify-space-between align-content-space-between">
          ...
          <v-card-text class="d-flex justify-space-between align-content-space-between">
            <v-layout column style="align-items: center;">
              <v-btn text plain rounded class="px-0" height="100" width="100">
                <v-avatar tile size="80">
                  <v-img :src="require('@/assets/svg/send-01.svg')" alt="Send"
            ...
            <v-layout column style="align-items: center;">
              <v-btn text plain rounded class="px-0" height="100" width="100">
                <v-avatar tile size="80">
                  <v-img :src="require('@/assets/svg/qr-code-01.svg')" alt="Receive"
            ...
            <v-layout column style="align-items: center;">
              <v-btn text plain rounded class="px-0" height="100" width="100">
                <v-avatar tile size="80">
                  <v-img :src="require('@/assets/svg/coins-swap-02.svg')" alt="Swap"
...
import StackedTokens from "@/components/StackedTokens.vue";
import RewardsChart from "@/components/charts/RewardsChart.vue";
import filters from "@/utils/filters";

export default {
  name: 'dashboard',
  components: {RewardsChart, StackedTokens, PortfolioChart},
  computed: {
    computeChartData() {
  ...
  methods: {
    ...
    tabClick(range) {
      this.$refs.portfolio.setExtremes(range)
    },
    getIconSize(item) {
