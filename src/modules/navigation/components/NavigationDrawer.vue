  ...
  computed: {
    ...
    items() {
      ...
      return [
        ...
        {title: 'Transaction', icon: require('@/assets/svg/transaction.svg'),link: '/transaction', enabled: networks.resolveTransactionsSupport(this.loggedWallet?.chain, this.loggedWallet?.network)},
