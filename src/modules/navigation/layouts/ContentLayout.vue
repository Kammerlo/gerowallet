    ...
    <v-app style="background: transparent !important;">
      ...
      <v-container class="pa-0" style="position: relative;">
        ...
        <div
          ...
          :style="{ backgroundImage: backgroundImageLoaded ? `url(${loggedWallet?.chain === Blockchain.APEX_PRIME || loggedWallet?.chain === Blockchain.APEX_VECTOR ? assets.apexBg : assets.cardanoBg})` : 'none' }"
        ></div>
