...
const dustGenerating = computed(() => balances.value?.dustGenerating ?? 0n);
...
const dustCurrent = computed(() => dustState.value?.current ?? 0n);
const dustCap = computed(() => dustState.value?.cap ?? 0n);
