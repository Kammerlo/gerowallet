                        ...
                        <v-col cols="12">
                            ...
                            <v-row>
                                <v-col cols="12">
                                    ...
                                    <CopyButton ref="copyAddress" x-small :value="multisigStore.getMultiSigWallet.id" v-if="multisigStore.getMultiSigWallet.id"></CopyButton>
                                </v-col>
                            </v-row>
                            <v-row>
